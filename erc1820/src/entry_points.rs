...
pub fn get_manager() -> EntryPoint {
    EntryPoint::new(
        ...
        vec![
            Parameter::new(ACCOUNT_RUNTIME_ARG_NAME, AccountHash::cl_type())
        ],
        CLType::Key,
...
pub fn set_manager() -> EntryPoint {
    EntryPoint::new(
        ...
        vec![
            Parameter::new(ACCOUNT_RUNTIME_ARG_NAME, AccountHash::cl_type()),
            Parameter::new(NEW_MANAGER_RUNTIME_ARG_NAME, AccountHash::cl_type())
        ],
        CLType::Key,
        EntryPointAccess::Public,
        EntryPointType::Contract,
...
pub fn set_interface_implementer() -> EntryPoint {
    EntryPoint::new(
        ...
        vec![
            Parameter::new(ACCOUNT_RUNTIME_ARG_NAME, AccountHash::cl_type()),
            Parameter::new(I_HASH_RUNTIME_ARG_NAME, Bytes::cl_type()),
            Parameter::new(IMPLEMENTER_RUNTIME_ARG_NAME, AccountHash::cl_type())
        ],
        AccountHash::cl_type(),
        EntryPointAccess::Public,
        EntryPointType::Contract,
...
pub fn implements_erc165_interfaceNoCache() -> EntryPoint {
    EntryPoint::new(
