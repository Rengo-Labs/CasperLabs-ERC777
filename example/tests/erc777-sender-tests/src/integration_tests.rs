...
mod tests {
    ...
    fn should_install() {
        ...
        fixture.add_erc777_sender_context();
        ...
        assert_eq!(
            ...
            "there is no balance to this account"
        );
    }
    ...
    #[test]
    fn should_transfer_tokens_from_erc777_sender() {
        let transfer_amount = U256::from(42);
        ...
        fixture.transfer_from_erc777_sender(
            Key::from(owner),
            Key::from(recipient),
            transfer_amount,
            String::default(),
    ...
    #[test]
    fn should_burn_from_erc777_sender() {
        let mut fixture = TestFixture::install_contract();
        fixture.add_erc1820_context();
        fixture.add_erc20_context();
        fixture.add_erc777_sender_context();
        ...
        fixture.burn_from_erc777_sender(
            Key::from(owner),
            U256::one(),
            String::default(),
            String::default(),
