...
use casper_execution_engine::core::{Address, engine_state::{Error as CoreError, ExecuteRequest}, execution::Error as ExecError};
use casper_types::{
    ...
    let install_request_1 = ExecuteRequestBuilder::standard(
        *DEFAULT_ACCOUNT_ADDR,
        ...
        runtime_args! {
            ...
            ARG_OPERATORS => Vec::<Address>::new(),
            ARG_GRANULARITY => U256::from(TOKEN_GRANULARITY),
